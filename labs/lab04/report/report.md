...
(image/23.jmg){#fig:023}

Рис.23

Проверяю с помощью команды ls:

(image/24.jmg){#fig:024}

Рис.24

Удаляю лишние файлы с помощью команды rm:

(image/25.jmg){#fig:025}

Рис.25

Добавляю файлы на GitHub:

(image/26.jmg){#fig:026}

Рис. 26

Отправляю файлы на сервер:

(image/27.jmg){#fig:027}
